...
// Digital Twin pages to restore from archived directory
const digitalTwinPages = [
  'analytics.js',
  'behavior.js', 
  'dashboard.js',
  'insights.js',
...
const archivedDir = 'frontend/pages_archived_20250717_193641/digital-twin';
const targetDir = 'frontend/src/pages/digital-twin';
...
digitalTwinPages.forEach(filename => {
  try {
...
console.log(`\n📊 Digital Twin Restoration Summary:`);
console.log(`✅ Successfully restored: ${successCount} pages`);
console.log(`❌ Errors: ${errorCount} pages`);
console.log(`📁 Target directory: ${targetDir}`);

if (successCount > 0) {
  console.log(`\n🎉 Digital Twin section restoration complete!`);
  console.log(`All ${successCount} pages are now available at /digital-twin/* routes`);
}