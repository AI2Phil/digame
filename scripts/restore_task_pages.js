...
// Task Management pages to restore from archived directory
const taskPages = [
  'ai-suggestions.js',
  'analytics.js',
  'index.js',
...
const archivedDir = 'frontend/pages_archived_20250717_193641/tasks';
const targetDir = 'frontend/src/pages/tasks';
...
console.log(`\n📊 Task Management Restoration Summary:`);
console.log(`✅ Successfully restored: ${successCount} pages`);
console.log(`❌ Errors: ${errorCount} pages`);
console.log(`📁 Target directory: ${targetDir}`);

if (successCount > 0) {
  console.log(`\n🎉 Task Management section restoration complete!`);
  console.log(`All ${successCount} pages are now available at /tasks/* routes`);
}