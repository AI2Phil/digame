...
const integrationHubRoutes = require('./routes/integrationHub');
const digitalTwinHubRoutes = require('./routes/digitalTwin');
const teamCollaborationRoutes = require('./routes/team');
const teamAnalyticsRoutes = require('./routes/teamAnalytics');
const teamCollaborationOptimizationRoutes = require('./routes/teamCollaboration');
const advancedReportingRoutes = require('./routes/advancedReporting');
const careerRoutes = require('./routes/career');
const careerDevelopmentRoutes = require('./routes/careerDevelopment');
...
app.use('/team-analytics', teamAnalyticsRoutes);
app.use('/team-collaboration', teamCollaborationOptimizationRoutes);
app.use('/advanced-reporting', advancedReportingRoutes);
app.use('/career', careerRoutes);
app.use('/api/career', careerDevelopmentRoutes);
