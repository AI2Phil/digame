...
from app.services.onboarding_service import ONBOARDING_DB, ONBOARDING_STEP_SEQUENCE
from app.models.onboarding_models import OnboardingStepUpdate, OnboardingPreferencesUpdate
...
async def test_post_step_update_api():
    ...
    response = client.post("/api/v1/onboarding/step", json=step_payload_dict)
...
async def test_post_preferences_api():
    ...
    response = client.post("/api/v1/onboarding/preferences", json=prefs_payload_dict)
