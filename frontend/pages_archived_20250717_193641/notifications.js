...
const NotificationsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader 
        title="Notifications"
        subtitle={`Manage your notifications and preferences${unreadCount > 0 ? ` (${unreadCount} unread)` : ''}`}
        breadcrumbs={[
              ...
              <div className="divide-y divide-gray-200">
                {filteredNotifications.length === 0 ? (
                  ...
                  filteredNotifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`p-6 hover:bg-gray-50 transition-colors ${getNotificationColor(notification.priority, notification.read)}`}
                    >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-gray-700">Instant Alerts</label>
                  <input
                    type="checkbox"
