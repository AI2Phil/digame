        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className={`px-2 py-1 text-xs font-medium rounded-full ${getConfidenceColor(predictions.productivity.confidence)}`}>
                {Math.round(predictions.productivity.confidence * 100)}% confidence
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white mb-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold">{predictions.productivity.current_score}</div>
                      <div className="text-sm opacity-90">Current</div>
                    </div>
                    <div className="text-2xl">→</div>
                    <div className="text-center">
                      <div className="text-2xl font-bold">{predictions.productivity.predicted_score}</div>
                      <div className="text-sm opacity-90">Predicted</div>
                    </div>
                  </div>
                  <div className="mt-3 text-sm">
                    Expected improvement: <span className="font-semibold">{predictions.productivity.change}</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="space-y-2">
                    {predictions.productivity.factors.map((factor, index) => (
              ...
              <div>
                ...
                <div className="space-y-3">
                  {predictions.productivity.recommendations.map((rec, index) => (
                ...
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-sm text-green-800">{predictions.productivity.timeline}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <div className="bg-green-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">{predictions.goals.on_track}</div>
                <div className="text-sm text-green-800">Goals On Track</div>
              </div>
              <div className="bg-yellow-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-yellow-600">{predictions.goals.at_risk}</div>
                <div className="text-sm text-yellow-800">Goals At Risk</div>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-blue-600">
                  {Math.round(predictions.goals.completion_probability * 100)}%
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-4">
                  {predictions.goals.at_risk_goals.map((goal, index) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  {predictions.goals.accelerated_goals.map((goal, index) => (
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {predictions.skills.development_areas.map((skill, index) => (
