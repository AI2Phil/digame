...
const GuestAuthentication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint = authMode === 'login' ? '/api/guest/auth/login' : '/api/guest/auth/register';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader 
        title="Guest Access"
        subtitle="Sign in or explore as a guest user"
        breadcrumbs={[
          { label: 'Guest Features', href: '/guest' },
          { label: 'Authentication', href: '/guest/auth' }
        ]}
      />
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-8">
          ...
          {/* Features Preview */}
          <div className="mt-6 pt-6 border-t border-gray-200">
            <h3 className="text-sm font-medium text-gray-900 mb-3">Guest Features Include:</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Browse platform capabilities</li>
              <li>• View demo content and examples</li>
              <li>• Access limited analytics</li>
              <li>• Request product demonstrations</li>
