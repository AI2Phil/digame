...
// Configuration Categories - extracted view from SystemConfigurationDashboard
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="px-6 py-8">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Configuration Categories</h1>
              <p className="text-gray-600">Manage system configuration by category</p>
            </div>
