      ...
      insights: [
        {
          ...
          message:
            'Your most productive hours are 9-11 AM. Consider scheduling important tasks during this window.',
          priority: 'high',
        ...
        },
        {
          ...
          message:
            "You're ahead of schedule on your Q1 objectives. Consider setting more ambitious targets.",
          priority: 'low',
          category: 'planning',
        },
      ],
    ...
    const getMockChatHistory = () => [
      {
        type: 'bot',
        message:
          "Hello! I've analyzed your recent work patterns. Would you like insights on optimizing your productivity?",
      ...
      try {
        ...
        if (response.ok) {
          ...
          const botMessage = {
            type: 'bot',
            message:
              "I'm here to help you optimize your professional development. You can ask me about productivity patterns, skill recommendations, or goal setting.",
            timestamp: new Date().toISOString(),
          };
          setChatHistory(prev => [...prev, botMessage]);
        }
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-green-600 font-medium">
                    {twinData?.metrics.twin_accuracy >= 90
                      ? 'Excellent'
                      : twinData?.metrics.twin_accuracy >= 75
                        ? 'Good'
                        : 'Learning'}
                  </span>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-1">
                  {twinData?.metrics.twin_accuracy || 94}%
                </h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-1">
                  {twinData?.metrics.data_points?.toLocaleString() || '1,247'}
                </h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-1">
                  {twinData?.metrics.goals_progress?.completed || 8}/
                  {twinData?.metrics.goals_progress?.total || 10}
                </h3>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    className={`text-sm font-medium ${
                      (twinData?.metrics.performance_change || 12) >= 0
                        ? 'text-green-600'
                        : 'text-red-600'
                    }`}
                  >
                    {(twinData?.metrics.performance_change || 12) >= 0 ? '+' : ''}
                    {twinData?.metrics.performance_change || 12}%
                  </span>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-1">
                  {twinData?.metrics.performance_score || 87.3}
                </h3>
                    ...
                    <>
                      <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                        ...
                        <p className="text-sm text-green-800">
                          Your most productive hours are 9-11 AM. Consider scheduling important
                      ...
                      <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                        ...
                        <p className="text-sm text-blue-800">
                          Based on your goals, I recommend focusing on data analysis skills this
                          month.
                        </p>
                      </div>
                      ...
                      <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                        ...
                        <p className="text-sm text-purple-800">
                          You're ahead of schedule on your Q1 objectives. Consider setting more
                          ambitious targets.
                        </p>
                      </div>
                    </>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Continuously learning from your behavior patterns
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Advanced algorithms analyzing your professional data
                  </p>
                </div>
