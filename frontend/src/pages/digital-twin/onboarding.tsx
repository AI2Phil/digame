          ...
          return (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                ...
                helps optimize your productivity, and provides personalized insights to help you
                achieve your goals.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Continuously learns from your behavior patterns
                  </p>
                </div>
                <div className="bg-green-50 p-6 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Helps you set and achieve professional goals
                  </p>
                </div>
                <div className="bg-purple-50 p-6 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Adapts to your unique work style and preferences
                  </p>
                </div>
              </div>
            </div>
          ...
          return (
            <div>
              ...
              <p className="text-gray-600 mb-8 text-center">
                Select all that apply. Your Digital Twin will help you achieve these objectives.
              </p>
        ...
        case 3:
          return (
            <div>
              ...
              <p className="text-gray-600 mb-8 text-center">
                Choose the work style that best describes you.
              </p>
        ...
        case 4:
          return (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                Your Digital Twin is ready to start learning from your work patterns and helping you
                achieve your goals.
              </p>
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-lg shadow-sm p-8 mb-8">{renderStepContent()}</div>
