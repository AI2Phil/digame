  ...
  const [isLoading, setIsLoading] = useState(false);
    ...
    const mockResponses = {
      chat: {
        message: 'How can I improve my productivity?',
        response:
          'Based on my analysis of your work patterns, I recommend focusing on your peak productivity hours between 9-11 AM for complex tasks. You show 23% higher focus during this window. Also, taking 15-minute breaks every 90 minutes could improve your sustained attention by up to 18%.',
        confidence: 0.91,
        suggestions: [
    ...
    const handleTestAPI = async () => {
      ...
      try {
        ...
        const backendAvailable = await fetch('/api/health')
          .then(res => res.ok)
          .catch(() => false);
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Digital Twin Intelligence API access and documentation"
          />
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">
                🚀 Digital Twin Intelligence API
              </h2>
              <p className="text-gray-600 mb-6">
                Access your Digital Twin's intelligence through RESTful API endpoints. Build custom
                integrations, automate workflows, and leverage AI insights programmatically.
              </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard(JSON.stringify(selectedAPI.example, null, 2))
                          }
