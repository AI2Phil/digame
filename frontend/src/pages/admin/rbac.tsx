...
interface RBACManagementPageProps {
  // Add any server-side props if needed
}

const RBACManagementPage: React.FC<RBACManagementPageProps> = () => {
  return (
    <>
      <Head>
        <title>RBAC Management - Digame</title>
        <meta
          name="description"
          content="Role-based access control management with permissions, roles, and security policies"
        />
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">RBAC Management</h1>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Role-based access control management with permissions, roles, and security policies
            </p>
