...
const UserManagementPage: React.FC<UserManagementPageProps> = () => {
  return (
    <>
      <Head>
        <title>User Management - Digame</title>
        <meta name="description" content="Complete user administration including user accounts, permissions, and access control" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Complete user administration including user accounts, permissions, and access control
            </p>
