...
const SystemAnalyticsPage: React.FC<SystemAnalyticsPageProps> = () => {
  return (
    <>
      <Head>
        <title>System Analytics - Digame</title>
        <meta name="description" content="System performance monitoring and analytics with comprehensive metrics and insights" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              System performance monitoring and analytics with comprehensive metrics and insights
            </p>
