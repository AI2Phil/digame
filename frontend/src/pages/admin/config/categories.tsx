...
interface ConfigurationCategoriesPageProps {
  // Add any server-side props if needed
}

const ConfigurationCategoriesPage: React.FC<ConfigurationCategoriesPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration Categories - Digame</title>
        <meta name="description" content="Browse configuration settings by category: Security, Database, Performance, Notifications" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Browse configuration settings by category: Security, Database, Performance, Notifications
            </p>
