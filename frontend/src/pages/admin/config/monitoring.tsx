...
interface ConfigurationMonitoringPageProps {
  // Add any server-side props if needed
}

const ConfigurationMonitoringPage: React.FC<ConfigurationMonitoringPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration Monitoring - Digame</title>
        <meta name="description" content="Monitor configuration changes and detect drift from expected values" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Monitor configuration changes and detect drift from expected values
            </p>
...
export default ConfigurationMonitoringPage;