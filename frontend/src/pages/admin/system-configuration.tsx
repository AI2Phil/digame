...
interface SystemConfigurationDashboardPageProps {
  // Add any server-side props if needed
}

const SystemConfigurationDashboardPage: React.FC<SystemConfigurationDashboardPageProps> = () => {
  return (
    <>
      <Head>
        <title>System Configuration Dashboard - Digame</title>
        <meta name="description" content="Comprehensive system configuration management with enterprise-grade controls and monitoring" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Comprehensive system configuration management with enterprise-grade controls and monitoring
            </p>
...
export default SystemConfigurationDashboardPage;