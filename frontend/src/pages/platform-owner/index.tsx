...
// Access control hook
const usePlatformOwnerAccess = (): AccessControlResult => {
...
const PlatformOwnerDashboard: React.FC = () => {
  ...
  if (!hasAccess) {
    return (
      <>
        <Head>
          <title>Access Restricted - Digame</title>
          <meta name="description" content="Access restricted to platform administrators" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <link rel="icon" href="/favicon.svg" type="image/svg+xml" />
        </Head>
