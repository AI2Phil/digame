...
const PlatformIntegrationsPage: React.FC<PlatformIntegrationsPageProps> = () => {
  return (
    <>
      <Head>
        <title>Platform Integrations - Digame Platform Owner</title>
        <meta name="description" content="Platform-wide integration management and monitoring" />
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-500 bg-gray-50 p-3 rounded">
                <strong>Note:</strong> This page was successfully restored from archived content (24772 characters) and converted to TypeScript with Next.js compatibility.
              </div>
            </div>
          </div>
        </div>
