...
const CertificationHub: React.FC = () => {
    ...
    earned: [
      {
        ...
        description:
          'Comprehensive certification covering React, JavaScript, and modern frontend development practices.',
      ...
      },
      {
        ...
        description:
          'Certification in digital marketing strategies, SEO, social media marketing, and analytics.',
      ...
      },
      {
        ...
        description:
          'Professional certification in user experience design, research, and prototyping.',
      ...
      },
      {
        ...
        description:
          'Foundation certification in data analysis using Python, pandas, and statistical methods.',
      ...
      },
      {
        ...
        description:
          'Comprehensive project management certification covering agile methodologies and leadership.',
        issuer: 'PM Institute',
    ...
    available: [
      {
        ...
        description:
          'Master advanced React concepts including performance optimization, testing, and architecture.',
        issuer: 'Digame Learning',
        requirements: [
      ...
      },
      {
        ...
        description:
          'Comprehensive machine learning certification covering algorithms, model training, and deployment.',
        issuer: 'AI Academy',
      ...
      },
      {
        ...
        description:
          'Professional certification in cloud architecture design and implementation using AWS.',
      ...
      },
      {
        ...
        description:
          'Advanced marketing certification focusing on growth hacking and data-driven marketing.',
        issuer: 'Growth Academy',
        requirements: [
          'Marketing fundamentals',
          'Analytics experience',
          'Complete growth experiments',
        ],
        estimatedHours: 35,
        level: 'Expert',
        category: 'Marketing',
  ...
  const enrollInCertification = certId => {
    ...
    setAvailableCerts(
      availableCerts.map(cert => (cert.id === certId ? { ...cert, enrolled: true } : cert))
    );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage your certifications and explore new certification opportunities"
        />
          ...
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Manage your certifications and explore new certification opportunities
              </p>
            </div>
          </div>
                    ...
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex items-center space-x-2 mb-3">
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getCategoryColor(cert.category)}`}
                          >
                            {cert.category}
                          </span>
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getLevelColor(cert.level)}`}
                          >
                            {cert.level}
                          </span>
                        </div>
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          ...
                          <div
                            className={`${isExpired(cert.expiryDate) ? 'text-red-600' : isExpiringSoon(cert.expiryDate) ? 'text-orange-600' : 'text-gray-600'}`}
                          >
                      ...
                      >
                        ...
                        <div className="mb-4">
                          ...
                          <div className="text-sm text-gray-600 space-y-1">
                            ...
                            {cert.prerequisite && <div>Prerequisite: {cert.prerequisite}</div>}
                          </div>
                        </div>
                  ...
                  {availableCerts.filter(cert => cert.enrolled).length === 0 && (
                    <div className="col-span-full text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">
                        Start working towards a new certification to track your progress here.
                      </p>
                      <button
