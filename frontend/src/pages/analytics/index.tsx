...
const AnalyticsPage: React.FC = () => {
  ...
  const handleRefresh = async () => {
    ...
    setRefreshing(false);
    toastSuccess('Analytics data refreshed');
  };
...
const OverviewSection: React.FC<OverviewSectionProps> = ({ analyticsData }) => (
  <div className="space-y-6">
    <ResizablePanelGroup
      direction="horizontal"
      className="rounded-lg border min-h-[300px] md:min-h-[400px]"
    >
...
const AlertsAndIssuesCard: React.FC = () => (
  <Card>
    <CardHeader>
      <CardTitle className="flex items-center gap-2">
