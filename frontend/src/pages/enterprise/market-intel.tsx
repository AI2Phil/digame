...
const MarketIntelligencePage: React.FC<MarketIntelligencePageProps> = () => {
  return (
    <>
      <Head>
        <title>Market Intelligence - Digame</title>
        <meta name="description" content="Advanced market intelligence with competitive analysis and business insights" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Advanced market intelligence with competitive analysis and business insights
            </p>
