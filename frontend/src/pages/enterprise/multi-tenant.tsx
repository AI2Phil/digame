...
interface MultiTenantConsolePageProps {
  // Add any server-side props if needed
}

const MultiTenantConsolePage: React.FC<MultiTenantConsolePageProps> = () => {
  return (
    <>
      <Head>
        <title>Multi-Tenant Console - Digame</title>
        <meta
          name="description"
          content="Advanced multi-tenant console with tenant isolation and management controls"
        />
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Multi-Tenant Console</h1>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Advanced multi-tenant console with tenant isolation and management controls
            </p>
