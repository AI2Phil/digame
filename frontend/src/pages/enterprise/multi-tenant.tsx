...
interface Multi-TenantConsolePageProps {
  // Add any server-side props if needed
}

const Multi-TenantConsolePage: React.FC<Multi-TenantConsolePageProps> = () => {
  return (
    <>
      <Head>
        <title>Multi-Tenant Console - Digame</title>
        <meta name="description" content="Advanced multi-tenant console with tenant isolation and management controls" />
...
export default Multi-TenantConsolePage;
