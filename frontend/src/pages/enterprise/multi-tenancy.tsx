...
interface MultiTenancyManagementPageProps {
  // Add any server-side props if needed
}

const MultiTenancyManagementPage: React.FC<MultiTenancyManagementPageProps> = () => {
  return (
    <>
      <Head>
        <title>Multi-Tenancy Management - Digame</title>
        <meta
          name="description"
          content="Comprehensive tenant administration, user management, and enterprise oversight"
        />
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Multi-Tenancy Management</h1>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Comprehensive tenant administration, user management, and enterprise oversight
            </p>
...
export default MultiTenancyManagementPage;
