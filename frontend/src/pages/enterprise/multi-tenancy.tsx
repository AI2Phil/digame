...
interface Multi-TenancyManagementPageProps {
  // Add any server-side props if needed
}

const Multi-TenancyManagementPage: React.FC<Multi-TenancyManagementPageProps> = () => {
  return (
    <>
      <Head>
        <title>Multi-Tenancy Management - Digame</title>
        <meta name="description" content="Comprehensive tenant administration, user management, and enterprise oversight" />
...
export default Multi-TenancyManagementPage;
