...
const EnterpriseDashboardPage: React.FC<EnterpriseDashboardPageProps> = () => {
  return (
    <>
      <Head>
        <title>Enterprise Dashboard - Digame</title>
        <meta name="description" content="Comprehensive enterprise dashboard with multi-tenant management and advanced analytics" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Comprehensive enterprise dashboard with multi-tenant management and advanced analytics
            </p>
