  ...
  getTenantAiFeatures: async tenantId => {
    ...
    if (tenantId === 1) {
      ...
      return {
        ...
        enable_workflow_automation: false,
        enable_intelligent_task_prioritization: true,
        enable_email_pattern_analysis: true,
    ...
    return {
      ...
      enable_workflow_automation: false,
      enable_intelligent_task_prioritization: false,
      enable_email_pattern_analysis: false,
      enable_language_learning_support: false,
      enable_skill_gap_analysis: false,
...
const aiFeatureConfigDefinition = [
  ...
  {
    key: 'enable_personalized_learning_recommendations',
                ...
                <CardContent>
                  {loadingTenantFeatures[tenant.id] ? (
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Switch
                                ...
                                onCheckedChange={newStatus =>
                                  handleAiFeatureToggle(tenant.id, feature.key, newStatus)
                                }
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI feature configuration not available for this tenant.
                    </p>
                  )}
                </CardContent>
              </Card>
        ...
        <CardContent>
          <div className="space-y-3">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      User: admin@acme.com - Multiple locations
                    </p>
                  </div>
            ...
            <Alert variant="success">
              {' '}
              {/* Or "info", "default" based on actual Alert component variants */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Comprehensive oversight of your enterprise deployment, AI features, and tenant
            management.
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="ai-features">{renderAiFeaturesTab()}</TabsContent>

          <TabsContent value="tenants">{renderTenantsTab()}</TabsContent>
