...
interface AdvancedMonitoringPageProps {
  // Add any server-side props if needed
}

const AdvancedMonitoringPage: React.FC<AdvancedMonitoringPageProps> = () => {
  return (
    <>
      <Head>
        <title>Advanced Monitoring - Digame</title>
        <meta
          name="description"
          content="Advanced system monitoring, alerting, metrics tracking, and service health monitoring"
        />
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Advanced Monitoring</h1>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Advanced system monitoring, alerting, metrics tracking, and service health monitoring
            </p>
