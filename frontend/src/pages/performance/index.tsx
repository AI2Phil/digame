  ...
  const performanceTools = [
    {
      ...
      description:
        'Live performance monitoring with automated optimizations and comprehensive metrics tracking',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive performance monitoring and optimization tools for your digital platform"
        />
      ...
      <Container maxWidth="xl" sx={{ py: 3 }}>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Monitor, analyze, and optimize your platform's performance with comprehensive tools and
            real-time insights
          </Typography>
        </Box>
        ...
        <Box mt={4} p={3} sx={{ bgcolor: 'grey.50', borderRadius: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            Our performance monitoring suite provides comprehensive insights into your platform's
            health and performance. From real-time monitoring to advanced analytics, you have all
            the tools needed to maintain optimal performance.
          </Typography>
