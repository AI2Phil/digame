...
const ReportsPage: React.FC = () => {
  ...
  const [customReportDateRange, setCustomReportDateRange] = useState('last-30-days');
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Generate and manage your productivity reports and analytics" />
              ...
              <CardContent>
                <div className="h-80 flex items-center justify-center bg-gray-50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500">Productivity chart will appear here</p>
                  </div>
                </div>
              </CardContent>
            </Card>
