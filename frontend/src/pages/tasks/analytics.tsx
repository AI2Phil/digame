  ...
  const mockAnalyticsData = {
    ...
    insights: [
      {
        ...
        description:
          'You complete 40% more tasks between 9-11 AM. Consider scheduling important work during this time.',
        impact: 'high',
        actionable: true,
      },
      {
    ...
    achievements: [
      ...
      },
      {
        ...
        description: 'Meet daily goals for 30 days',
        earned: false,
        progress: 23,
      },
      {
        id: 4,
        name: 'Team Player',
        description: 'Help 5 team members with tasks',
        earned: false,
        progress: 3,
      },
    ],
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600">
                      {currentData.overview.trends.tasksCreated} this period
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600">
                      {currentData.overview.trends.tasksCompleted} this period
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-600">
                      {currentData.overview.productivityScore}
                    </p>
                    <p className="text-xs text-green-600">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {currentData.overview.onTimeRate}%
                    </p>
                  </div>
                  ...
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <span
                          className={`text-sm font-bold ${getCompletionColor(category.completionRate)}`}
                        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="text-3xl font-bold text-blue-600">
                    {currentData.performance.weeklyTrends.thisWeek.completed}
                  </div>
                  <div className="text-sm text-gray-600">Tasks Completed</div>
                  <div className="text-xs text-green-600 mt-1">
                    {currentData.performance.weeklyTrends.change.completed} vs last week
                  </div>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-3xl font-bold text-green-600">
                    {currentData.performance.weeklyTrends.thisWeek.created}
                  </div>
                  <div className="text-sm text-gray-600">Tasks Created</div>
                  <div className="text-xs text-red-600 mt-1">
                    {currentData.performance.weeklyTrends.change.created} vs last week
                  </div>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-3xl font-bold text-purple-600">
                    {currentData.performance.weeklyTrends.thisWeek.productivity}
                  </div>
                  <div className="text-sm text-gray-600">Productivity Score</div>
                  <div className="text-xs text-green-600 mt-1">
                    {currentData.performance.weeklyTrends.change.productivity} vs last week
                  </div>
                </div>
              </div>
            </CardContent>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {currentData.timeAnalysis.avgSessionLength} min
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-red-600">
                        {currentData.timeAnalysis.distractionRate}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Peak Days</span>
                      <span className="font-medium">
                        {currentData.timeAnalysis.peakDays.join(', ')}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {currentData.achievements.map(achievement => (
                  ...
                  >
                    <div className="text-2xl mb-2">{achievement.earned ? '🏆' : '🔒'}</div>
                    ...
                    {achievement.earned ? (
                      ...
                      <div className="mt-2">
                        <Progress
                          value={
                            (achievement.progress / (achievement.name.includes('30') ? 30 : 10)) *
                            100
                          }
                          className="h-1"
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          ...
                          {achievement.name.includes('30')
                            ? 30
                            : achievement.name.includes('10')
                              ? 10
                              : 5}
                        </p>
                      </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Block your calendar from 9-11 AM for high-priority tasks to maximize your peak
                    performance window.
                  </p>
                </div>
                <div className="p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-sm text-green-700 mt-1">
                    Group similar admin tasks together on Fridays to reduce context switching and
                    improve efficiency.
                  </p>
                </div>
                <div className="p-4 bg-purple-50 rounded-lg">
                  ...
                  <p className="text-sm text-purple-700 mt-1">
                    Add 1-day buffers to high-priority tasks to reduce stress and improve quality of
                    work.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600">
                    #{currentData.teamComparison.userRank}
                  </div>
                  <div className="text-sm text-gray-600">Your Rank</div>
                  <div className="text-xs text-gray-500 mt-1">
                    out of {currentData.teamComparison.totalMembers} members
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600">
                    {currentData.teamComparison.userScore}
                  </div>
                  <div className="text-sm text-gray-600">Your Score</div>
                  <div className="text-xs text-green-500 mt-1">
                    +
                    {(
                      currentData.teamComparison.userScore - currentData.teamComparison.teamAverage
                    ).toFixed(1)}{' '}
                    vs team avg
                  </div>
                </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600">
                    {currentData.teamComparison.teamAverage}
                  </div>
