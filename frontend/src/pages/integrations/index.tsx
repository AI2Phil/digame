...
const IntegrationsPage: React.FC = () => {
  ...
  const getHealthIcon = (health: Connection['health_status']): React.ReactElement => {
    switch (health) {
      case 'healthy':
  ...
  const initiateOAuthFlow = (provider: Provider) => {
  ...
  const testConnection = async (connectionId: number): Promise<void> => {
