...
const TeamCollaborationPage: React.FC<TeamCollaborationPageProps> = ({ initialData }) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">Please log in to access collaboration optimization features.</p>
          <a
            href="/auth/login"
  ...
  const hasCollaborationAccess = user.subscriptionTier === 'team' || 
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Upgrade to Team or Enterprise subscription to access AI-powered collaboration optimization.
          </p>
          <a
            href="/pricing"
            className="bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors"
    ...
    <ToastProvider>
      <div className="min-h-screen bg-gray-50">
        <Head>
          ...
          <meta name="description" content="AI-powered team workflow optimization and collaboration recommendations." />
