...
interface ConfigurationAuditTrailPageProps {
  // Add any server-side props if needed
}

const ConfigurationAuditTrailPage: React.FC<ConfigurationAuditTrailPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration Audit Trail - Digame</title>
        <meta name="description" content="Complete audit trail of all configuration changes with user attribution" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Complete audit trail of all configuration changes with user attribution
            </p>
...
export default ConfigurationAuditTrailPage;