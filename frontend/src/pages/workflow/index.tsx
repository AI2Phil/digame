                  ...
                  <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900">
                          {analytics.total_runs.toLocaleString()}
                        </p>
                      </div>
                          ...
                          {workflows.map(workflow => (
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between mb-4">
                                ...
                                <span
                                  className={`px-2 py-1 text-xs font-medium rounded-full ${getComplexityColor(workflow.complexity)}`}
                                >
                              ...
                              <div className="flex items-start space-x-3 mb-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center space-x-4">
                                    <span
                                      className={`px-2 py-1 text-xs font-medium rounded-full ${getComplexityColor(template.complexity)}`}
                                    >
                                      {template.complexity}
                                    </span>
                                    <span className="text-xs text-gray-500">
                          ...
                          <div>
                            ...
                            <div className="space-y-3">
                              {[
                                ...
                                {
                                  workflow: 'Content Publishing Schedule',
                                  action: 'Paused by user',
                                  time: '1 day ago',
                                  status: 'paused',
                                },
                                {
                                  workflow: 'Lead Qualification Pipeline',
                                  action: 'Failed - API timeout',
                                  time: '2 days ago',
                                  status: 'error',
                                },
                              ].map((activity, index) => (
