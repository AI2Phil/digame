                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        {match.verified && <Star className="w-4 h-4 text-blue-500 fill-current" />}
                      </div>
                    ...
                    <div className="text-right">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${getMatchScoreColor(match.matchScore)}`}
                      >
