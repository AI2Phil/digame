              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {analyticsData?.overview?.totalConnections}
                  </p>
                  <p className="text-xs text-green-600">
                    +{analyticsData?.overview?.newConnections} this month
                  </p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {formatPercentage(analyticsData?.overview?.postEngagement)}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {analyticsData?.overview?.eventAttendance}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {analyticsData?.overview?.forumPosts}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {formatNumber(
                      analyticsData?.engagement?.totalLikes +
                        analyticsData?.engagement?.totalComments +
                        analyticsData?.engagement?.totalShares
                    )}
                  </p>
                    ...
                    <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500">
                          {analyticsData?.network?.connectionGrowth
                  ...
                  <div>
                    ...
                    <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500">Posts, comments, and likes by day</p>
                      </div>
                    </div>
                  </div>
                </div>
