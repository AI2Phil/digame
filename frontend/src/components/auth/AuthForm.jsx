      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <Card className="w-full max-w-md p-6 relative">
          ...
          >
            ...
            {isLogin && (
              <div className="flex items-center space-x-2 py-3 px-2 bg-yellow-100 border-2 border-yellow-400 rounded-md my-2">
                <label className="flex items-center space-x-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-gray-900 select-none">Remember me for 30 days</span>
                </label>
              </div>
            )}
