  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'User Behavior Analytics', icon: <Brain className="w-4 h-4" />, path: '/analytics/user-behavior', subtitle: 'AI-POWERED', description: 'Comprehensive behavioral insights and pattern analysis' },
