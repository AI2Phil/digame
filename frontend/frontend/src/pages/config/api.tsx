...
interface ConfigurationAPIPageProps {
  // Add any server-side props if needed
}

const ConfigurationAPIPage: React.FC<ConfigurationAPIPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration API - Digame</title>
        <meta name="description" content="Programmatic configuration management via REST API" />
...
export default ConfigurationAPIPage;
