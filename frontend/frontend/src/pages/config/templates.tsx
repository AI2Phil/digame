...
interface ConfigurationTemplatesPageProps {
  // Add any server-side props if needed
}

const ConfigurationTemplatesPage: React.FC<ConfigurationTemplatesPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration Templates - Digame</title>
        <meta name="description" content="Pre-configured templates for common system setups and deployments" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Pre-configured templates for common system setups and deployments
            </p>
