...
interface ConfigurationBackupsPageProps {
  // Add any server-side props if needed
}

const ConfigurationBackupsPage: React.FC<ConfigurationBackupsPageProps> = () => {
  return (
    <>
      <Head>
        <title>Configuration Backups - Digame</title>
        <meta name="description" content="Create, manage, and restore configuration backups with version control" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600 mb-4">
              Create, manage, and restore configuration backups with version control
            </p>
...
export default ConfigurationBackupsPage;
