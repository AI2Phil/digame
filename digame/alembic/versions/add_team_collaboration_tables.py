...
Revision ID: add_team_collaboration_tables
Revises: add_enhanced_onboarding
Create Date: 2025-06-22 16:36:00.000000
...
revision = 'add_team_collaboration_tables'
down_revision = 'add_enhanced_onboarding'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_team_performance_metrics_measurement_date'), 'team_performance_metrics', ['measurement_date'], unique=False)
    ...
    op.create_index(op.f('ix_team_workflows_status'), 'team_workflows', ['status'], unique=False)


def downgrade():
    # Drop tables in reverse order
    op.drop_index(op.f('ix_team_workflows_status'), table_name='team_workflows')
    ...
    op.drop_index(op.f('ix_team_performance_metrics_measurement_date'), table_name='team_performance_metrics')
