...
from digame.app.services.ai_integration_service import AIIntegrationService
from digame.app.config import settings  # Assuming OpenAI API URL is in settings
...
try:
    from digame.app.config import settings
except ImportError:
