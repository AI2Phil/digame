...
from .notification_schemas import Notification, NotificationCreate # Import new notification schemas
...
__all__ = [
    ...
    "Notification", "NotificationCreate", # Add notification schemas to __all__
