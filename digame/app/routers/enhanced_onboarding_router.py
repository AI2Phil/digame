...
from digame.app.models.onboarding_models import (
    UserOnboardingStatus, 
    OnboardingStepUpdate, 
    OnboardingPreferencesUpdate
)
from digame.app.services.enhanced_onboarding_service import EnhancedOnboardingService
from digame.app.database import get_db
from digame.app.auth.auth_service import get_current_user  # Assuming this exists
