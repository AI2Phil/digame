...
def upgrade():
    ...
    create_table_safe('user_connections', create_user_connections)
    
    # Peer Matching Table
    def create_peer_matches():
    ...
    create_table_safe('peer_matches', create_peer_matches)
    ...
    create_table_safe('social_metrics', create_social_metrics)
    ...
    create_table_safe('user_skills', create_user_skills)
    ...
    create_table_safe('course_categories', create_course_categories)
    ...
    create_table_safe('courses', create_courses)
    ...
    create_table_safe('course_enrollments', create_course_enrollments)
    ...
    create_table_safe('learning_progress', create_learning_progress)
    ...
    create_table_safe('learning_recommendations', create_learning_recommendations)
