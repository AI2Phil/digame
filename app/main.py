...
from .routers import security_router # Import the security router - re-enabled for E2E tests
...
app.include_router(security_router.router, prefix="/api", tags=["Security"]) # Add security router - re-enabled for E2E tests
