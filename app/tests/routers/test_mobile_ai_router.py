...
from app.schemas.mobile_ai_schemas import (
...
from app.services.mobile_ai_service import MobileAIService

# Router to be tested
from app.routers.mobile_ai_router import router as mobile_ai_api_router # Ensure correct import alias
