...
# from app.schemas.language_learning_schemas import TranslationResponse, DefinitionResponse
...
def test_translate_endpoint_success(client, mock_language_learning_service, mock_current_active_user_for_lang_learn):
    ...
    from app.services.language_learning_service import get_language_learning_service
