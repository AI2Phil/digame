...
from app.schemas.communication_style_schemas import CommunicationStyleAnalysisResponse
...
def test_analyze_endpoint_success(client, mock_communication_style_service, mock_current_active_user_for_comm_style):
    ...
    from app.services.communication_style_service import get_communication_style_service
