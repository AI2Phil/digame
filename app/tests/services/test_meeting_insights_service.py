...
def test_get_analysis_success(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    ...
    with patch('digame.app.crud.user_setting_crud.get_user_setting', return_value=mock_user_setting_model_insights):
        # Action
        analysis = service.get_meeting_analysis(current_user_id=mock_user_model_insights.id, meeting_text=meeting_text)
...
def test_get_analysis_feature_disabled(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_tenant_user_link_insights):
    # Arrange
    ...
    with pytest.raises(HTTPException) as exc_info:
        service.get_meeting_analysis(current_user_id=mock_user_model_insights.id, meeting_text="Test meeting text.")

    assert exc_info.value.status_code == 403
    assert "feature is not enabled" in exc_info.value.detail.lower()

def test_get_analysis_no_user_settings(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
    service = MeetingInsightsService(db=mock_db_session, ai_integration_service=mock_ai_integration_service)
...
def test_get_analysis_no_api_key_in_settings(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
...
def test_get_analysis_empty_api_key(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
...
def test_get_analysis_invalid_api_key_external_error(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
...
def test_get_analysis_user_not_in_tenant(mock_db_session, mock_ai_integration_service, mock_user_model_insights):
    # Arrange
...
def test_get_analysis_corrupted_tenant_features_json(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_tenant_user_link_insights):
    # Arrange
...
def test_get_analysis_corrupted_user_settings_api_keys_json(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
...
def test_get_analysis_empty_input_text_error_from_client(mock_db_session, mock_ai_integration_service, mock_user_model_insights, mock_tenant_model_insights, mock_user_setting_model_insights, mock_tenant_user_link_insights):
    # Arrange
    mock_tenant_model_insights.features = {"meeting_insights": True}
    service = MeetingInsightsService(db=mock_db_session, ai_integration_service=mock_ai_integration_service)
    ...
    with patch('digame.app.crud.user_setting_crud.get_user_setting', return_value=mock_user_setting_model_insights):
        # Action
        with pytest.raises(HTTPException) as exc_info:
            service.get_meeting_analysis(current_user_id=mock_user_model_insights.id, meeting_text=meeting_text)
...
def test_get_analysis_tenant_link_missing_tenant_attr(mock_db_session, mock_ai_integration_service, mock_user_model_insights):
    # Arrange
