...
def create_new_team(
    ...
    """
    return team_service.create_team(team_create=team, current_user_id=getattr(current_user, 'id', 0))
...
def read_team_details(
    ...
    if not team_service.is_user_team_member(getattr(current_user, 'id', 0), db_team) and not team_service.is_system_admin(getattr(current_user, 'id', 0)):
...
def update_existing_team(
    ...
    """
    return team_service.update_team_details(team_id=team_id, team_update=team_update, current_user_id=getattr(current_user, 'id', 0))
...
def delete_existing_team(
    ...
    """
    return team_service.remove_team(team_id=team_id, current_user_id=getattr(current_user, 'id', 0))
...
def add_member_to_team(
    ...
    """
    return team_service.add_team_member(team_id=team_id, member_action=member_action, current_user_id=getattr(current_user, 'id', 0))
...
def update_team_member_details( # e.g., role
    ...
    """
    return team_service.update_team_member_role(team_id=team_id, user_id_to_update=user_id_to_update, member_update=member_update, current_user_id=getattr(current_user, 'id', 0))
...
def remove_member_from_team_endpoint( # Renamed to avoid conflict with service method
    ...
    """
    return team_service.remove_member_from_team(team_id=team_id, user_id_to_remove=user_id_to_remove, current_user_id=getattr(current_user, 'id', 0))
...
def get_team_analytics_dashboard(
    ...
    """
    return team_service.get_team_performance_analytics(team_id=team_id, current_user_id=getattr(current_user, 'id', 0))
...
def create_team_metric(
    ...
    return team_service.add_team_performance_metric(team_id, metric, getattr(current_user, 'id', 0))
...
def list_team_metrics(
    ...
    return team_service.get_metrics_for_team(team_id, getattr(current_user, 'id', 0), skip, limit)
...
def get_specific_team_metric(
    ...
    return team_service.get_team_metric_for_team(team_id=team_id, metric_id=metric_id, current_user_id=getattr(current_user, 'id', 0))
...
def update_specific_team_metric(
    ...
    return team_service.update_team_metric_for_team(team_id=team_id, metric_id=metric_id, metric_update=metric_update, current_user_id=getattr(current_user, 'id', 0))
...
def delete_specific_team_metric(
    ...
    return team_service.delete_team_metric_entry_for_team(team_id=team_id, metric_id=metric_id, current_user_id=getattr(current_user, 'id', 0))
...
def create_team_skill_gap_entry(
    ...
    if skill_gap.team_id != team_id:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Team ID in path and body must match.")
    return team_service.add_team_skill_gap(team_id, skill_gap, getattr(current_user, 'id', 0))
...
def list_team_skill_gaps(
    ...
    return team_service.get_skill_gaps_for_team(team_id, getattr(current_user, 'id', 0), skip, limit)
...
def get_specific_team_skill_gap(
    ...
    return team_service.get_team_skill_gap_for_team(team_id=team_id, skill_gap_id=skill_gap_id, current_user_id=getattr(current_user, 'id', 0))
...
def update_specific_team_skill_gap(
    ...
    return team_service.update_team_skill_gap_entry_for_team(team_id=team_id, skill_gap_id=skill_gap_id, skill_gap_update=skill_gap_update, current_user_id=getattr(current_user, 'id', 0))
...
def delete_specific_team_skill_gap(
    ...
    return team_service.delete_team_skill_gap_entry_for_team(team_id=team_id, skill_gap_id=skill_gap_id, current_user_id=getattr(current_user, 'id', 0))
...
def create_team_workflow_entry(
    ...
    if workflow.team_id != team_id:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Team ID in path and body must match.")
    return team_service.add_team_workflow(team_id, workflow, getattr(current_user, 'id', 0))
...
def list_team_workflows(
    ...
    return team_service.get_workflows_for_team(team_id, getattr(current_user, 'id', 0), skip, limit)
...
def get_specific_team_workflow(
    ...
    return team_service.get_team_workflow_for_team(team_id=team_id, workflow_id=workflow_id, current_user_id=getattr(current_user, 'id', 0))
...
def update_specific_team_workflow(
    ...
    return team_service.update_team_workflow_entry_for_team(team_id=team_id, workflow_id=workflow_id, workflow_update=workflow_update, current_user_id=getattr(current_user, 'id', 0))
...
def delete_specific_team_workflow(
    ...
    return team_service.delete_team_workflow_entry_for_team(team_id=team_id, workflow_id=workflow_id, current_user_id=getattr(current_user, 'id', 0))
...
def create_or_update_team_development_plan(
    ...
    """
    return team_service.plan_team_development(team_id=team_id, development_plan_data=plan_data, current_user_id=getattr(current_user, 'id', 0))
