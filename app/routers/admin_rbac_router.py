...
from ..models.rbac import UserRoleAssignment, Role
...
# --- Database Dependency ---
# We now import get_db from app.db to avoid circular imports
# This is just a comment block explaining the dependency injection pattern
# The actual get_db function is imported from app.db
...
# from app.routers import admin_rbac_router
...
# The schemas import `from app import crud, schemas` assumes that
# `digame/app/__init__.py` makes `crud` and `schemas` available, or you adjust the import paths.
# e.g., from app.crud import rbac_crud
# e.g., from app.schemas import rbac_schemas
# Corrected imports for crud and schemas:
# from app.crud import rbac_crud
# from app.schemas import rbac_schemas
# The `from app import crud, schemas` might work if `digame/app/__init__.py` exports them.
...
# `from app.schemas import rbac_schemas`
#
# And `from app.models import user as user_model` to `from app.models import user as user_model_sqla`
